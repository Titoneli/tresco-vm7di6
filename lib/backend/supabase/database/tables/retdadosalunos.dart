...
class RetdadosalunosTable extends SupabaseTable<RetdadosalunosRow> {
  @override
  String get tableName => 'retdadosalunos';

  @override
  RetdadosalunosRow createRow(Map<String, dynamic> data) =>
      RetdadosalunosRow(data);
}

class RetdadosalunosRow extends SupabaseDataRow {
  RetdadosalunosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RetdadosalunosTable();
