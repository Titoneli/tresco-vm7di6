...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2F8D2F);
  late Color secondary = const Color(0xFF2F8D2F);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1F2034);
  late Color secondaryText = const Color(0xFF1F2034);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF3F3F3);
  late Color accent1 = const Color(0xFF2F8D2F);
  ...
  late Color iconsBG = const Color(0xFFFED57C);
}
