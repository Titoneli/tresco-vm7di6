...
import 'dashboard_resp_via_van_m_model.dart';
export 'dashboard_resp_via_van_m_model.dart';

class DashboardRespViaVanMWidget extends StatefulWidget {
  const DashboardRespViaVanMWidget({super.key});

  static String routeName = 'dashboardRespViaVanM';
  static String routePath = '/dashRespViaVan';

  @override
  State<DashboardRespViaVanMWidget> createState() =>
      _DashboardRespViaVanMWidgetState();
}

class _DashboardRespViaVanMWidgetState
    extends State<DashboardRespViaVanMWidget> {
  late DashboardRespViaVanMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardRespViaVanMModel());
                        ...
                        child: Padding(
                          ...
                          child: PageView(
                            ...
                            onPageChanged: (_) async {
                              _model.paginaAtiva = valueOrDefault<int>(
                                                    ...
                                                    children: [
                                                      ...
                                                      FlutterFlowPlacePicker(
                                                        ...
                                                        onSelect:
                                                            (place) async {
                                                          safeSetState(() =>
                                                              _model.placePickerDestinationValue =
                                                                  place);
                                                        },
                                                        defaultText:
                                                            'Destino ?',
                                      ...
                                      child: Container(
                                        ...
                                        child: custom_widgets.GoogleMapsRoute(
                                          ...
                                          onRouteDrawn: (totalDistanceValue,
                                            ...
                                            _model.staticDurationText =
                                                staticDurationText;
                                            safeSetState(() {});
                                            FFAppState().latLongAluno = _model
                                                .placePickerDestinationValue
                                                .latLng;
                                            safeSetState(() {});
                                          },
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  FFButtonWidget(
                                                    onPressed: () {
                                                      print(
                                                          'btnExibirMotoristas pressed ...');
                                                    },
                                                    text: 'Exibir Motoristas',
                                                    icon: Icon(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    padding: MediaQuery
                                                                        .viewInsetsOf(
                                                                            context),
                                                                    child:
                                                                        BtsViaVanAssinanteEditarMWidget(
                                                                      idUsuario:
                                                                          FFAppState()
                                                                              .idUsuario,
                                                                      obrigatorio:
