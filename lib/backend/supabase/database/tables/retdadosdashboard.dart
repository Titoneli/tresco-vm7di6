...
class RetdadosdashboardTable extends SupabaseTable<RetdadosdashboardRow> {
  @override
  String get tableName => 'retdadosdashboard';

  @override
  RetdadosdashboardRow createRow(Map<String, dynamic> data) =>
      RetdadosdashboardRow(data);
}

class RetdadosdashboardRow extends SupabaseDataRow {
  RetdadosdashboardRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RetdadosdashboardTable();
