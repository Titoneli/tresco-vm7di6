...
import 'bts_aluno_lista_model.dart';
export 'bts_aluno_lista_model.dart';

class BtsAlunoListaWidget extends StatefulWidget {
  const BtsAlunoListaWidget({
    super.key,
    this.idAluno,
  });
  ...
  @override
  State<BtsAlunoListaWidget> createState() => _BtsAlunoListaWidgetState();
}

class _BtsAlunoListaWidgetState extends State<BtsAlunoListaWidget>
    with TickerProviderStateMixin {
  late BtsAlunoListaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsAlunoListaModel());
                                              ...
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        3.0, 0.0, 0.0, 0.0),
                                                child: Text(
                                                  'Alunos ${FFAppState().recCountAlunosLista.toString()}',
                                    ...
                                    child: InkWell(
                                      ...
                                      child: PagedListView<ApiPagingParams,
                                        ...
                                        builderDelegate:
                                          ...
                                          itemBuilder:
                                              (context, _, alunosListaIndex) {
                                            final alunosListaItem = _model
                                                .listViewPagingController!
                                                .itemList![alunosListaIndex];
                                            return Container(
                                              width: double.infinity,
                                              height: 35.0,
                                              decoration: BoxDecoration(
