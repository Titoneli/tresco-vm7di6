...
import 'bts_via_van_motorista_adicionar_model.dart';
export 'bts_via_van_motorista_adicionar_model.dart';

class BtsViaVanMotoristaAdicionarWidget extends StatefulWidget {
  const BtsViaVanMotoristaAdicionarWidget({super.key});

  @override
  State<BtsViaVanMotoristaAdicionarWidget> createState() =>
      _BtsViaVanMotoristaAdicionarWidgetState();
}

class _BtsViaVanMotoristaAdicionarWidgetState
    extends State<BtsViaVanMotoristaAdicionarWidget> {
  late BtsViaVanMotoristaAdicionarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsViaVanMotoristaAdicionarModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  'Crie uma nova conta de motorista \nescolar  ',
                                  style: FlutterFlowTheme.of(context)
                                      .titleLarge
                                      .override(
                                        font: GoogleFonts.interTight(
                          ...
                          if (responsiveVisibility(
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .emailLeadTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                  if (!isAndroid && !isiOS)
                                    TextInputFormatter.withFunction(
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.apiResAdicionaColab =
                              ...
                              'idEmpresa': 1,
                              'domCargo': 'MotoristaViaVan',
                              'usuario': _model.telefoneLeadTextController.text,
                              'senha': _model.confirmaSenhaTextController.text,
                              'ativo': true,
                              'loginLiberado': true,
                              'codEmpresa': '1',
