...
import 'bts_aluno_obs_motorista_m_model.dart';
export 'bts_aluno_obs_motorista_m_model.dart';

class BtsAlunoObsMotoristaMWidget extends StatefulWidget {
  const BtsAlunoObsMotoristaMWidget({
    super.key,
  ...
  @override
  State<BtsAlunoObsMotoristaMWidget> createState() =>
      _BtsAlunoObsMotoristaMWidgetState();
}

class _BtsAlunoObsMotoristaMWidgetState
    extends State<BtsAlunoObsMotoristaMWidget> {
  late BtsAlunoObsMotoristaMModel _model;
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<List<CorDominioRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CorDominioRow>
                                    ddwExclusaoEscolaCorDominioRowList =
                                    snapshot.data!;

                                return FlutterFlowDropDown<String>(
                                  controller: _model
                                          .ddwExclusaoEscolaValueController ??=
                                      FormFieldController<String>(null),
                                  options: ddwExclusaoEscolaCorDominioRowList
                                      .map((e) => e.nomeDominio)
                                      .toList(),
                                  onChanged: (val) => safeSetState(() =>
                                      _model.ddwExclusaoEscolaValue = val),
                        ...
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.ddwExclusaoEscolaValue == null) {
                                return;
                              }
                              ...
                              if (_model.apiResAlunoMotorista!.length > 0) {
                                Navigator.pop(context);
                                ScaffoldMessenger.of(context).clearSnackBars();
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Cooperativa informada do descontemplamento com sucesso.',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryBackground,
                                      ),
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Descontemplar Aluno'),
                                      content: Text(
                                          'Falha ao tentar salvar. Entre em contato com o suporte.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
