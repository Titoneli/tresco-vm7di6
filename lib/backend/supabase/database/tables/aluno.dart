...
class AlunoTable extends SupabaseTable<AlunoRow> {
  @override
  String get tableName => 'aluno';

  @override
  AlunoRow createRow(Map<String, dynamic> data) => AlunoRow(data);
}

class AlunoRow extends SupabaseDataRow {
  AlunoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AlunoTable();
