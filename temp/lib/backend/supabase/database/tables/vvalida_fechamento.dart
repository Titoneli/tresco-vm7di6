...
class VvalidaFechamentoTable extends SupabaseTable<VvalidaFechamentoRow> {
  @override
  String get tableName => 'vvalida_fechamento';

  @override
  VvalidaFechamentoRow createRow(Map<String, dynamic> data) =>
      VvalidaFechamentoRow(data);
}

class VvalidaFechamentoRow extends SupabaseDataRow {
  VvalidaFechamentoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VvalidaFechamentoTable();
