...
import 'bts_a_t_f_adicionar_model.dart';
export 'bts_a_t_f_adicionar_model.dart';

class BtsATFAdicionarWidget extends StatefulWidget {
  const BtsATFAdicionarWidget({super.key});

  @override
  State<BtsATFAdicionarWidget> createState() => _BtsATFAdicionarWidgetState();
}

class _BtsATFAdicionarWidgetState extends State<BtsATFAdicionarWidget> {
  late BtsATFAdicionarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsATFAdicionarModel());

    _model.cpfCNPJTextController1 ??= TextEditingController();
    _model.cpfCNPJFocusNode1 ??= FocusNode();

    _model.cpfCNPJTextController2 ??= TextEditingController();
    _model.cpfCNPJFocusNode2 ??= FocusNode();
                        ...
                        children: [
                              ...
                              child: FutureBuilder<List<CorDominioRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.ddwSerieValueController ??=
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 3.0, 0.0, 3.0),
                            child: TextFormField(
                              controller: _model.cpfCNPJTextController1,
                              focusNode: _model.cpfCNPJFocusNode1,
                              autofocus: false,
                              obscureText: false,
                              ...
                              validator: _model.cpfCNPJTextController1Validator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 3.0, 0.0, 3.0),
                            child: TextFormField(
                              controller: _model.cpfCNPJTextController2,
                              focusNode: _model.cpfCNPJFocusNode2,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Destino',
                              ...
                              validator: _model.cpfCNPJTextController2Validator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: _model.nomeLeadTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [
                                if (!isAndroid && !isiOS)
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.telefoneLeadFocusNode,
                                    autofocus: false,
                                    autofillHints: [
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      alignLabelWithHint: true,
                                      hintText: 'Telefone / WhatsApp do Aluno',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                            font: GoogleFonts.inter(
                          ...
                          Padding(
                            ...
                            child: FutureBuilder<List<CorDominioRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FlutterFlowDropDown<String>(
                                  controller:
                                      _model.ddwTipoAlunoValueController ??=
                                          FormFieldController<String>(
                                    _model.ddwTipoAlunoValue ??= 'Cooperativa',
                                  ),
                                  options: ddwTipoAlunoCorDominioRowList
                                      .map((e) => e.nomeDominio)
                                      .toList(),
                                  onChanged: (val) => safeSetState(
                                      () => _model.ddwTipoAlunoValue = val),
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height: 50.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                  ...
                                  hidesUnderline: true,
                                  disabled:
                                      FFAppState().idEscolaUsuario != null,
                                  isSearchable: false,
                                  isMultiSelect: false,
                                );
                              },
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.apiResBuscaAluno =
                                await AlunoTable().queryRows(
                            ...
                            if (_model.apiResBuscaAluno != null &&
                                (_model.apiResBuscaAluno)!.isNotEmpty) {
                              await showDialog(
                                context: context,
                              ...
                              _model.apiResAdicionaAluno =
                                ...
                                'ativo': false,
                                'nomeAluno': _model.nomeLeadTextController.text,
                                'domTipoAluno': _model.ddwTipoAlunoValue,
                                'whatsAppAluno':
                                    _model.telefoneLeadTextController.text,
                                ...
                                'cpfAluno': _model.cpfCNPJTextController1.text,
                              ...
                              if (_model.apiResAdicionaAluno?.idAluno != null) {
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Adicionar Aluno'),
                                      content: Text('Falha ao cadastrar aluno'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                                              Navigator.pop(alertDialogContext),
