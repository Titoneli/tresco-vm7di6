...
import 'bts_aluno_exclusao_model.dart';
export 'bts_aluno_exclusao_model.dart';

class BtsAlunoExclusaoWidget extends StatefulWidget {
  const BtsAlunoExclusaoWidget({
    super.key,
  ...
  @override
  State<BtsAlunoExclusaoWidget> createState() => _BtsAlunoExclusaoWidgetState();
}

class _BtsAlunoExclusaoWidgetState extends State<BtsAlunoExclusaoWidget> {
  late BtsAlunoExclusaoModel _model;
