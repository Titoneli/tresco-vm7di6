...
class RetdempfpjTable extends SupabaseTable<RetdempfpjRow> {
  @override
  String get tableName => 'retdempfpj';

  @override
  RetdempfpjRow createRow(Map<String, dynamic> data) => RetdempfpjRow(data);
}

class RetdempfpjRow extends SupabaseDataRow {
  RetdempfpjRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RetdempfpjTable();
