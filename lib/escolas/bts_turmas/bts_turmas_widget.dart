...
class BtsTurmasWidget extends StatefulWidget {
  const BtsTurmasWidget({
    super.key,
    int? idEscola,
  ...
  @override
  State<BtsTurmasWidget> createState() => _BtsTurmasWidgetState();
}

class _BtsTurmasWidgetState extends State<BtsTurmasWidget> {
  late BtsTurmasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsTurmasModel());
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<List<CorDominioRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CorDominioRow> ddwTurnoCorDominioRowList =
                                  snapshot.data!;

                              return FlutterFlowDropDown<String>(
                                controller: _model.ddwTurnoValueController ??=
                                    FormFieldController<String>(null),
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.apiResAdicionaTurno?.idTurma != null) {
                              Navigator.pop(context);
