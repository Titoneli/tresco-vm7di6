...
class EscolaTable extends SupabaseTable<EscolaRow> {
  @override
  String get tableName => 'escola';

  @override
  EscolaRow createRow(Map<String, dynamic> data) => EscolaRow(data);
}

class EscolaRow extends SupabaseDataRow {
  EscolaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => EscolaTable();
