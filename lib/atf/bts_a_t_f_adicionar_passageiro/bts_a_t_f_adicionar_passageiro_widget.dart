...
class BtsATFAdicionarPassageiroWidget extends StatefulWidget {
  const BtsATFAdicionarPassageiroWidget({
    super.key,
    required this.idAtf,
  });
  ...
  @override
  State<BtsATFAdicionarPassageiroWidget> createState() =>
      _BtsATFAdicionarPassageiroWidgetState();
}

class _BtsATFAdicionarPassageiroWidgetState
    extends State<BtsATFAdicionarPassageiroWidget> {
  late BtsATFAdicionarPassageiroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsATFAdicionarPassageiroModel());
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Emissor do Documento',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.apiResAdicionaPassageiro
                                    ?.idAtfPassageiro !=
                                null) {
                              Navigator.pop(context);
