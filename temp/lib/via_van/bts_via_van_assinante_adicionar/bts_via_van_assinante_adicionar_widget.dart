...
import 'bts_via_van_assinante_adicionar_model.dart';
export 'bts_via_van_assinante_adicionar_model.dart';

class BtsViaVanAssinanteAdicionarWidget extends StatefulWidget {
  const BtsViaVanAssinanteAdicionarWidget({super.key});

  @override
  State<BtsViaVanAssinanteAdicionarWidget> createState() =>
      _BtsViaVanAssinanteAdicionarWidgetState();
}

class _BtsViaVanAssinanteAdicionarWidgetState
    extends State<BtsViaVanAssinanteAdicionarWidget> {
  late BtsViaVanAssinanteAdicionarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsViaVanAssinanteAdicionarModel());
