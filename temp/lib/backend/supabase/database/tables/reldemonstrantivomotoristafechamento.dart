...
class ReldemonstrantivomotoristafechamentoTable
    extends SupabaseTable<ReldemonstrantivomotoristafechamentoRow> {
  @override
  String get tableName => 'reldemonstrantivomotoristafechamento';

  @override
  ReldemonstrantivomotoristafechamentoRow createRow(
          Map<String, dynamic> data) =>
      ReldemonstrantivomotoristafechamentoRow(data);
}

class ReldemonstrantivomotoristafechamentoRow extends SupabaseDataRow {
  ReldemonstrantivomotoristafechamentoRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => ReldemonstrantivomotoristafechamentoTable();
