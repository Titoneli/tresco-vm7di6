...
class BtsTurmasEditarWidget extends StatefulWidget {
  const BtsTurmasEditarWidget({
    super.key,
    int? idEscola,
    this.idTurma,
  ...
  @override
  State<BtsTurmasEditarWidget> createState() => _BtsTurmasEditarWidgetState();
}

class _BtsTurmasEditarWidgetState extends State<BtsTurmasEditarWidget> {
  late BtsTurmasEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsTurmasEditarModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<List<TurmaRow>>(
                    future: TurmaTable().querySingleRow(
                      queryFn: (q) => q
                          .eqOrNull(
                            'idEscola',
                            widget.idEscola,
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<TurmaRow> formTurmaRowList = snapshot.data!;

                      final formTurmaRow = formTurmaRowList.isNotEmpty
                          ? formTurmaRowList.first
                          : null;
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.apiResEditarTurma != null &&
                                (_model.apiResEditarTurma)!.isNotEmpty) {
                              Navigator.pop(context);
