...
class RetdadosveiculoTable extends SupabaseTable<RetdadosveiculoRow> {
  @override
  String get tableName => 'retdadosveiculo';

  @override
  RetdadosveiculoRow createRow(Map<String, dynamic> data) =>
      RetdadosveiculoRow(data);
}

class RetdadosveiculoRow extends SupabaseDataRow {
  RetdadosveiculoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RetdadosveiculoTable();
  ...
  String? get nomecooperado => getField<String>('nomecooperado');
  set nomecooperado(String? value) => setField<String>('nomecooperado', value);
