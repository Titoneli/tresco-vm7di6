...
class AppAlunosConferenciaTable extends SupabaseTable<AppAlunosConferenciaRow> {
  @override
  String get tableName => 'app_alunos_conferencia';

  @override
  AppAlunosConferenciaRow createRow(Map<String, dynamic> data) =>
      AppAlunosConferenciaRow(data);
}

class AppAlunosConferenciaRow extends SupabaseDataRow {
  AppAlunosConferenciaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppAlunosConferenciaTable();
  ...
  bool? get domCheckAluno => getField<bool>('domCheckAluno');
  set domCheckAluno(bool? value) => setField<bool>('domCheckAluno', value);

  bool? get domsitalunoativo => getField<bool>('domsitalunoativo');
  set domsitalunoativo(bool? value) =>
      setField<bool>('domsitalunoativo', value);

  bool? get domsitalunoaguardando => getField<bool>('domsitalunoaguardando');
  set domsitalunoaguardando(bool? value) =>
      setField<bool>('domsitalunoaguardando', value);

  bool? get domsitalunoinativo => getField<bool>('domsitalunoinativo');
  set domsitalunoinativo(bool? value) =>
      setField<bool>('domsitalunoinativo', value);
  ...
  String? get placaveiculo => getField<String>('placaveiculo');
  set placaveiculo(String? value) => setField<String>('placaveiculo', value);

  String? get nomemotorista => getField<String>('nomemotorista');
  set nomemotorista(String? value) => setField<String>('nomemotorista', value);

  String? get cidadeestado => getField<String>('cidadeestado');
  set cidadeestado(String? value) => setField<String>('cidadeestado', value);

  String? get endcompleto => getField<String>('endcompleto');
  set endcompleto(String? value) => setField<String>('endcompleto', value);

  double? get valaluno => getField<double>('valaluno');
  set valaluno(double? value) => setField<double>('valaluno', value);

  String? get valalunomotorista => getField<String>('valalunomotorista');
  set valalunomotorista(String? value) =>
      setField<String>('valalunomotorista', value);

  String? get stescola => getField<String>('stescola');
  set stescola(String? value) => setField<String>('stescola', value);
}
