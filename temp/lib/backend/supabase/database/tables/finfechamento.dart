...
class FinfechamentoTable extends SupabaseTable<FinfechamentoRow> {
  @override
  String get tableName => 'finfechamento';

  @override
  FinfechamentoRow createRow(Map<String, dynamic> data) =>
      FinfechamentoRow(data);
}

class FinfechamentoRow extends SupabaseDataRow {
  FinfechamentoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FinfechamentoTable();
