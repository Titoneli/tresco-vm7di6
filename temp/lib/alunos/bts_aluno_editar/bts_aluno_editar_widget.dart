...
import 'bts_aluno_editar_model.dart';
export 'bts_aluno_editar_model.dart';

class BtsAlunoEditarWidget extends StatefulWidget {
  const BtsAlunoEditarWidget({
    super.key,
    this.idAluno,
  });
  ...
  @override
  State<BtsAlunoEditarWidget> createState() => _BtsAlunoEditarWidgetState();
}

class _BtsAlunoEditarWidgetState extends State<BtsAlunoEditarWidget>
    with TickerProviderStateMixin {
  late BtsAlunoEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BtsAlunoEditarModel());
    ...
    _model.longFocusNode ??= FocusNode();
    ...
    _model.rgRespFocusNode ??= FocusNode();

    _model.telRespFocusNode ??= FocusNode();
      ...
      child: Padding(
        ...
        child: FutureBuilder<List<AlunoRow>>(
          ...
          builder: (context, snapshot) {
            ...
            List<AlunoRow> containerAlunoRowList = snapshot.data!;

            final containerAlunoRow = containerAlunoRowList.isNotEmpty
                ? containerAlunoRowList.first
                : null;
                                ...
                                tabs: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Icon(
                                        FFIcons
                                            .kaccountChildInvert80dp000000FILL0Wght400GRAD0Opsz48,
                                        size: 32.0,
                                      ),
                                      Tab(
                                        text: '',
                                ...
                                children: [
                                                          ...
                                                          child: FutureBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                  String>(
                                                                controller: _model
                                                                        .ddwSitAlunoValueController ??=
                                                                    FormFieldController<
                                                                        String>(
                                                                  _model.ddwSitAlunoValue ??=
                                                                      containerAlunoRow
                                                                          ?.domSitAluno,
                                                                ),
                                                                options: ddwSitAlunoCorDominioRowList
                                                                    .map((e) =>
                                                                        e.nomeDominio)
                                                                    .toList(),
                                                                onChanged: (val) =>
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FutureBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              List<CorDominioRow>
                                                                  ddwExclusaoAlunoCorDominioRowList =
                                                                  snapshot
                                                                      .data!;
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                  String>(
                                                                controller: _model
                                                                        .ddwExclusaoAlunoValueController ??=
                                                                    FormFieldController<
                                                                        String>(
                                                                  _model.ddwExclusaoAlunoValue ??=
                                                                      containerAlunoRow
                                                                          ?.domExclusaoEscola,
                                                                ),
                                                                options: ddwExclusaoAlunoCorDominioRowList
                                                                    .map((e) =>
                                                                        e.nomeDominio)
                                                                    .toList(),
                                                                onChanged: (val) =>
                                                          ...
                                                          child: FutureBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                  String>(
                                                                controller: _model
                                                                        .ddwTipoAlunoValueController ??=
                                                                    FormFieldController<
                                                                        String>(
                                                                  _model.ddwTipoAlunoValue ??=
                                                                      containerAlunoRow
                                                                          ?.domTipoAluno,
                                                                ),
                                                                options: ddwTipoAlunoCorDominioRowList
                                                                    .map((e) =>
                                                                        e.nomeDominio)
                                                                    .toList(),
                                                                onChanged: (val) =>
                                                      ...
                                                      child: Builder(
                                                        ...
                                                        return FlutterFlowGoogleMap(
                                                          ...
                                                          initialLocation: _model
                                                            ...
                                                            containerAlunoRow
                                                                ?.latlongAluno,
                                                            'LatLng(lat: -19.7922135, lng: -43.9389577)',
                                                          )),
                                                          markers: [
                                                            FlutterFlowMarker(
                                                              _googleMapMarker
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                        .nomeRespTextController ??=
                                                    TextEditingController(
                                                  text: containerAlunoRow
                                                      ?.nomeResponsavel,
                                                ),
                                                focusNode:
                                                    _model.nomeRespFocusNode,
                                                autofocus: false,
                                                textCapitalization:
                                                    TextCapitalization
                                                        .characters,
                                            ...
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                        .rgRespTextController ??=
                                                    TextEditingController(
                                                  text: containerAlunoRow
                                                      ?.rgResponsavel,
                                                ),
                                                focusNode:
                                                    _model.rgRespFocusNode,
                                                autofocus: false,
                                                textCapitalization:
                                                    TextCapitalization
                                                        .characters,
                                                ...
                                                Expanded(
                                                  child: Padding(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .telRespTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            _model.apiResGeraAutorizacao =
                                                await WhgeraautorizacaorespCall
                                                    .call(
                                              nomeAluno:
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_updataSupabase =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                downloadUrls =
                                                  ...
                                                  bucketName: 'trescofotos',
                                                  selectedFiles: selectedMedia,
                                                );
                                              } finally {
                                                ScaffoldMessenger.of(context)
                                                    .hideCurrentSnackBar();
                                                _model.isDataUploading_updataSupabase =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_updataSupabase =
                                                      selectedUploadedFiles
                                                          .first;
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  _model
                                                      .uploadedFileUrl_updataSupabase,
                                                  style: TextStyle(
                                                    color: FlutterFlowTheme.of(
                                                            context)
                                                        .primaryText,
                                            ...
                                            if (_model.uploadedFileUrl_updataSupabase !=
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                SnackBar(
                                                  content: Text(
                                                    'Falha ao atualiza foto do aluno',
                                                    style: TextStyle(
                                                      color:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                    ...
                                                    await showModalBottomSheet(
                                                      ...
                                                      builder: (context) {
                                                        return Padding(
                                                          ...
                                                          child:
                                                              BtsTurmasWidget(
                                                            idEscola: _model.ddwEscolaValue !=
                                                                    null
                                                                ? _model
                                                                    .ddwEscolaValue!
                                                                : containerAlunoRow
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Expanded(
                                        child: FutureBuilder<
                                            List<AlunoHistoricoRow>>(
                                          future:
                                              AlunoHistoricoTable().queryRows(
                                            queryFn: (q) => q
                                                .eqOrNull(
                                                  'idaluno',
                                                  containerAlunoRow.idAluno,
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                final listViewAlunoHistoricoRow =
                                                    listViewAlunoHistoricoRowList[
                                                        listViewIndex];
                                                return Row(
                                                  mainAxisSize:
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(16.0, 6.0, 12.0, 6.0),
                                                                              child: Row(
                                                                                mainAxisSize: MainAxisSize.max,
                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                children: [
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Padding(
                                                                                                ...
                                                                                                child: Text(
                                                                                                  valueOrDefault<String>(
                                                                                                    listViewAlunoHistoricoRow.operacao,
                                                                                                    '-',
                                                                                                  ),
                                                                                              ...
                                                                                              Padding(
                                                                                                ...
                                                                                                child: Text(
                                                                                                  valueOrDefault<String>(
                                                                                                    listViewAlunoHistoricoRow.campo,
                                                                                                    '-',
                                                                                                  ),
                                                                                                  textAlign: TextAlign.start,
                                                                                                  style: FlutterFlowTheme.of(context).bodyLarge.override(
                                                                                          ...
                                                                                          Padding(
                                                                                            ...
                                                                                            child: Text(
                                                                                              valueOrDefault<String>(
                                                                                                listViewAlunoHistoricoRow.alteradoEm.toString(),
                                                                                                '-',
                                                                                              ),
                                                                                              textAlign: TextAlign.start,
                                                                                          ...
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Padding(
                                                                                                ...
                                                                                                child: Text(
                                                                                                  '${valueOrDefault<String>(
                                                                                                    listViewAlunoHistoricoRow.valorAnterior,
                                                                                                    '-',
                                                                                                  )} - ${listViewAlunoHistoricoRow.valorAtual}',
                                                                                                  textAlign: TextAlign.start,
                                ...
                                onPressed: () async {
                                  ...
                                  _model.apiResEditaUsuario =
                                    ...
                                    data: {
                                      ...
                                      'rgResponsavel':
                                          _model.rgRespTextController.text,
                                      'telResponsavel':
                                          _model.telRespTextController.text,
                                      'cepAluno': _model.cepTextController.text,
                                      'endAluno': FFAppState().enderecoAluno,
                                      'numAluno':
                                          _model.numeroTextController.text,
                                      'compAluno':
                                          _model.compTextController.text,
                                      'bairroAluno':
                                          _model.bairroTextController.text,
                                      'cidadeAluno':
                                          _model.cidadeTextController.text,
                                      'ufAluno': _model.ufTextController.text,
                                      'autorizacaoEntregue':
                                          _model.swcAutorizacaoEntregueValue,
                                      'domSerie':
